...
const routes = [
    ...
    {
        path: 'payoutgrid',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_payoutgrid_payoutgrid_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./payoutgrid/payoutgrid.module */ 6858)).then(m => m.PayoutgridPageModule)
    },
    {
        path: 'lampoffers',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_lampoffers_lampoffers_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./lampoffers/lampoffers.module */ 9066)).then(m => m.LampoffersPageModule)
    },
    {
        path: 'forgotpassword',
    ...
    {
        path: 'totalcases',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_totalcases_totalcases_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./totalcases/totalcases.module */ 5689)).then(m => m.TotalcasesPageModule)
    },
    {
        path: 'invalidcases',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_invalidcases_invalidcases_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./invalidcases/invalidcases.module */ 1494)).then(m => m.InvalidcasesPageModule)
    },
    {
        path: 'admin',
    ...
    },
    {
        ...
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_adminpendingagents_adminpendingagents_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./adminpendingagents/adminpendingagents.module */ 4259)).then(m => m.AdminpendingagentsPageModule)
    },
    {
        path: 'adminpendingbusiness',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_adminpendingbusiness_adminpendingbusiness_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./adminpendingbusiness/adminpendingbusiness.module */ 3064)).then(m => m.AdminpendingbusinessPageModule)
    },
    {
        path: 'adminmonthlypayouts',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_adminmonthlypayouts_adminmonthlypayouts_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./adminmonthlypayouts/adminmonthlypayouts.module */ 3182)).then(m => m.AdminmonthlypayoutsPageModule)
    },
    {
        path: 'adminpayoutsetting',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_adminpayoutsetting_adminpayoutsetting_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./adminpayoutsetting/adminpayoutsetting.module */ 236)).then(m => m.AdminpayoutsettingPageModule)
    },
    {
        path: 'addbank',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_addbank_addbank_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./addbank/addbank.module */ 8283)).then(m => m.AddbankPageModule)
    },
    {
        path: 'viewmemberlist',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_viewmemberlist_viewmemberlist_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./viewmemberlist/viewmemberlist.module */ 696)).then(m => m.ViewmemberlistPageModule)
    },
    {
        path: 'viewbusinesslist',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_viewbusinesslist_viewbusinesslist_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./viewbusinesslist/viewbusinesslist.module */ 1234)).then(m => m.ViewbusinesslistPageModule)
    },
    {
        path: 'adminbusinessedit',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_adminbusinessedit_adminbusinessedit_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./adminbusinessedit/adminbusinessedit.module */ 9144)).then(m => m.AdminbusinesseditPageModule)
    },
    {
        path: 'adminuploadpayoutgrid',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_adminuploadpayoutgrid_adminuploadpayoutgrid_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./adminuploadpayoutgrid/adminuploadpayoutgrid.module */ 571)).then(m => m.AdminuploadpayoutgridPageModule)
    },
    {
        path: 'viewimage',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_viewimage_viewimage_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./viewimage/viewimage.module */ 3751)).then(m => m.ViewimagePageModule)
    },
    {
        path: 'adminuploadlampoffer',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_adminuploadlampoffer_adminuploadlampoffer_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./adminuploadlampoffer/adminuploadlampoffer.module */ 8700)).then(m => m.AdminuploadlampofferPageModule)
    },
    {
        path: 'adminmanagemember',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_adminmanagemember_adminmanagemember_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./adminmanagemember/adminmanagemember.module */ 6657)).then(m => m.AdminmanagememberPageModule)
    },
    {
        path: 'memberedit',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_memberedit_memberedit_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./memberedit/memberedit.module */ 3030)).then(m => m.MembereditPageModule)
    },
    {
        path: 'payoutallbusiness',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_payoutallbusiness_payoutallbusiness_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./payoutallbusiness/payoutallbusiness.module */ 2621)).then(m => m.PayoutallbusinessPageModule)
    },
];
...
let AppComponent = class AppComponent {
  ...
  initializeApp() {
    ...
    this.platform.ready().then( /*#__PURE__*/(0,_Volumes_Sabyasachi_My_Projects_Not_To_Use_insuremenewgit_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      try {
