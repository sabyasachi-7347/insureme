...
/***/ 1056:
/*!************************************************!*\
  !*** ./src/app/services/commondata.service.ts ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "CommondataService": () => (/* binding */ CommondataService)
/* harmony export */ });
...
let CommondataService = class CommondataService {
    constructor() {
        this.allPendingAgents = [];
        this.allPendingBusiness = [];
        this.allBusinessUsers = [];
        this.allInvalidBusiness = [];
    }
};
CommondataService.ctorParameters = () => [];
CommondataService = (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__decorate)([
...
/***/ 5827:
/*!*************************************************!*\
  !*** ./src/app/services/pluginutill.service.ts ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "PluginutillService": () => (/* binding */ PluginutillService)
/* harmony export */ });
...
/* harmony import */ var _ionic_native_camera_ngx__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ionic-native/camera/ngx */ 6018);




let PluginutillService = class PluginutillService {
  constructor(camera) {
    this.camera = camera;
  }
  ...
  captureImage() {
    ...
    return (0,_Volumes_Sabyasachi_My_Projects_Not_To_Use_insuremenewgit_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      yield _this.camera.getPicture(_this.options).then(imageData => {
        // imageData is either a base64 encoded string or a file URI
        // If it's base64 (DATA_URL):
        let base64Image = 'data:image/jpeg;base64,' + imageData;
        _this.clickedImage = base64Image;
        return _this.clickedImage;
      }, err => {
  ...
  selectFromDevice() {
    ...
    return (0,_Volumes_Sabyasachi_My_Projects_Not_To_Use_insuremenewgit_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this2.options = {
        ...
        mediaType: _this2.camera.MediaType.ALLMEDIA,
        sourceType: _this2.camera.PictureSourceType.PHOTOLIBRARY
      };
      yield _this2.camera.getPicture(_this2.options).then(imageData => {
        // imageData is either a base64 encoded string or a file URI
        // If it's base64 (DATA_URL):
        let base64Image = 'data:image/jpeg;base64,' + imageData;
        _this2.clickedImage = base64Image;
        return _this2.clickedImage;
      }, err => {
        console.log(err); // Handle error
      });
    })();
...
PluginutillService.ctorParameters = () => [{
  type: _ionic_native_camera_ngx__WEBPACK_IMPORTED_MODULE_1__.Camera
}];

PluginutillService = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.Injectable)({
  providedIn: 'root'
})], PluginutillService);
...
/***/ 1460:
/*!*********************************************!*\
  !*** ./src/app/viewimage/viewimage.page.ts ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _viewimage_page_html_ngResource__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./viewimage.page.html?ngResource */ 577);
/* harmony import */ var _viewimage_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./viewimage.page.scss?ngResource */ 6315);
...
ViewimagePage = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.Component)({
        ...
        template: _viewimage_page_html_ngResource__WEBPACK_IMPORTED_MODULE_0__,
        styles: [_viewimage_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__]
    })
], ViewimagePage);
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,_Volumes_Sabyasachi_My_Projects_Not_To_Use_insuremenewgit_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,_Volumes_Sabyasachi_My_Projects_Not_To_Use_insuremenewgit_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,_Volumes_Sabyasachi_My_Projects_Not_To_Use_insuremenewgit_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
...
/***/ 6315:
/*!**********************************************************!*\
  !*** ./src/app/viewimage/viewimage.page.scss?ngResource ***!
  \**********************************************************/
/***/ ((module) => {

module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJ2aWV3aW1hZ2UucGFnZS5zY3NzIn0= */";

/***/ }),

/***/ 577:
/*!**********************************************************!*\
  !*** ./src/app/viewimage/viewimage.page.html?ngResource ***!
  \**********************************************************/
/***/ ((module) => {

module.exports = "<ion-content>\n<ion-icon name=\"close\" style=\"float:right;\" (click)=\"dismissModal()\"></ion-icon>\n  <img [src]=\"image\">\n</ion-content>\n";
