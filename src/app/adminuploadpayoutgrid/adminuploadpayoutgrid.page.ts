...
@Component({
  ...
  templateUrl: './adminuploadpayoutgrid.page.html',
  styleUrls: ['./adminuploadpayoutgrid.page.scss'],
})
export class AdminuploadpayoutgridPage implements OnInit {
  results:any = [];
  allUsers:any = [];
  name: any="";
  email: any="";
 ...
 async ngOnInit() {
  ...
  async uploadDetails(){
        ...
        await this.firestore.collection("payoutsgrid").doc(this.email.trim()+this.selectedDate.trim()).set({
          "name":this.name.trim(),
          ...
          "image":this.uploadpaygrid,
                    ...
                    alert("Payout Set for month "+this.selectedDate);
                    this.name = "";
                    this.email = "";
                    this.selectedDate = "";
                    this.uploadpaygrid = "";
