...
let AddbusinessPage = class AddbusinessPage {
  ...
  addNewBusiness() {
    ...
    return (0,C_Users_ADMIN_Desktop_Incurance_Project_insuremenewgit_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this.curentUser = JSON.parse(localStorage.userData); // this.auth.createUserWithEmailAndPassword(this.email.trim(),this.mobile.toString().trim()).then(async (data)=>{
      // console.log(data);
      // if(data.user.uid)
      // {

      yield _this.firestore.collection("business").doc().set({
        "typeOfBorrow": _this.addBusinessForm.value.typeOfBorrow.trim(),
        "bankName": _this.addBusinessForm.value.bankName.trim(),
        "lanNo": _this.addBusinessForm.value.lanNo.trim(),
        "name": _this.addBusinessForm.value.name.trim(),
        "disburseDate": _this.selectedDate.trim(),
        "disbursedAmount": _this.addBusinessForm.value.disbursedAmount.trim(),
        // "currentPoint":this.addBusinessForm.value.currentPoint.trim(),
        "remarks": _this.addBusinessForm.value.remarks.trim(),
        "createdBy": _this.curentUser.email
      }).catch(error => {
        console.log(error);
        ...
        _this.addBusinessForm.reset(); //  this.goto('login');
...
module.exports = ".loginButton {\n  text-align: center;\n}\n\n.buttonCont {\n  text-align: center;\n}\n\n.serror-message {\n  color: #f20e0e;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
